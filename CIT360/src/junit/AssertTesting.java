...
public class AssertTesting {
    ...
    /**
     * Test the following Assert cases: assertEquals, assertArrayEquals,
     * assertFalse, assertTrue, assertNotSame, assertSame, assertNotNull,
    ...
    /**
     * assertFalse, assertTrue, assertNotSame, assertSameassertNotNull,
     * assertNull, assertThat - is(), isA(), matches(), anyof()
     * isA(String.class)
     */
